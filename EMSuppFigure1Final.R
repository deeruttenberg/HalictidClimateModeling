...
hiveq <- function(d, BirthRate, b, Sf) {
  write.csv(d,
            file = paste0(deparse(BirthRate),".",deparse(b),".",deparse(Sf),".",".FinalSuppFigure1.csv"),
            row.names = FALSE)
}
...
DIY <- 140 #Length from diapause > diapause
